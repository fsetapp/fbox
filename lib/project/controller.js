...
import { FILE_TAG, JSON_DATA_EXT, MODEL_EXT, HTML_EXT } from "../pkgs/proj.js"

import { save as saveSchMeta } from "../sch/meta.js"
import { update as updateSch } from "../sch.js"
import { FmodelTree, SchMetaForm, blankTree, blankSchMetaForm, DataTree, HTMLTree } from "../elements.js"
...
/*
  There are 2 kinds of file, one is sole-purpose file, another one is mixed file.
...
export const changeFile = (conf) => {
  ...
  if (fileStore) {
    ...
    switch (fileStore.ext) {
      case MODEL_EXT:
        FmodelTree({ store: fileStore, target: $fileBody, select: fmodelname, focus })
