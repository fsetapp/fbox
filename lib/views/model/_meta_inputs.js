...
export const renderTypeMeta = (sch) => {
  ...
  switch (sch.t) {
    ...
    case M.LIST:
      ...
      htmls = [
        integerInput(sch, "min", { keyDisplay: "Min Items" }),
        integerInput(sch, "max", { keyDisplay: "Max Items" }),
    ...
    case M.TUPLE: htmls = [
      ...
      break
    case M.DICT: htmls = [
      integerInput(sch, "min", { keyDisplay: "Min Properties" }),
      integerInput(sch, "max", { keyDisplay: "Max Properties" })
    ]
      break
    ...
    case M.STRING:
      ...
      // "max" : 0 --sch.min ---------> infinity
      htmls = [
        integerInput(sch, "min", { keyDisplay: "Min Length" }),
        integerInput(sch, "max", { keyDisplay: "Max Length" }),
