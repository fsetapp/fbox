...
const viewModel = (assigns) => {
  switch (true) {
    ...
    case assigns.sch.ext == Proj.KEEP_EXT:
      return nothing
...
const typeText = (sch, ui) => {
  switch (true) {
    case sch.t == Proj.FILE && sch.ext == Proj.MODEL_EXT: return html`.sch`
    case sch.t == Proj.FILE && sch.ext == Proj.JSON_DATA_EXT: return html`.data`
    case sch.t == Proj.FILE && sch.ext == Proj.HTML_EXT: return html`.html`
  }
}
