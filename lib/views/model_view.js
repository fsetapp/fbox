...
import { viewItself, groupSize, keyedOrIndexed } from "./_iterator_view.js"
...
export const renderRoot = (el, root, opts = {}) => {
  try {
    ...
    assign(ui, opts.ui)
    if (opts.ui.lineClass) assign(ui, { tab: opts.ui.tab + 2 })
...
const viewModel = (assigns) => {
  switch (true) {
    case assigns.ui.level == assigns.ui.rootLevel:
      assign(assigns.ui, { expanded: true })
    ...
    case [M.LIST].includes(assigns.sch.t):
      if (assigns.sch.sch.hasOwnProperty("fields") ||
        ...
        assign(assigns.ui, { expanded: false })
