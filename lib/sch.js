  ...
  update(store, path, (a, m) => {
    ...
    switch (true) {
      ...
      case newSch.type != a.type:
        let { title, description, rw, required, $anchor, key, _tag } = a
        Object.assign(newSch, { metadata: { title, description, rw, required }, $anchor, key, _tag })
        return newSch
      default:
        return a
    }
