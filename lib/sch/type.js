...
export const int8 = () => ({ t: INT8, min: -128, max: 127 })
export const int16 = () => ({ t: INT16, min: -32768, max: 32767 })
export const int32 = () => ({ t: INT32, min: -2147483648, max: 2147483647 })
export const uint8 = () => ({ t: UINT8, min: 0, max: 255 })
export const uint16 = () => ({ t: UINT16, min: 0, max: 65535 })
export const uint32 = () => ({ t: UINT32, min: 0, max: 4294967295 })
...
export const ref = (anchor) => ({ t: REF, $r: anchor })
