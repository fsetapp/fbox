...
export const PROJECT = 256
export const FILE = 255
export const FOLDER = 254
export const MODEL_EXT = 253
export const JSON_EXT = 252
export const KEEP_EXT = 251
...
export const project = (opts) => Object.assign(({ t: PROJECT, fields: [] }), opts)
export const file = (opts) => Object.assign(({ t: FILE, fields: [], ext: MODEL_EXT, tag: "file" }), opts)
export const folder = (opts) => Object.assign(({ t: FOLDER, fields: [putAnchor(() => file({ ext: KEEP_EXT }))] }), opts)
