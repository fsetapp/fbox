import { putAnchor, ref } from "./core.js"
import * as Actions from "../actions.js"
import { string, number, bool, structSheet as Model } from "./model.js"
...
const toVal = (a, strval) => {
  ...
  if (a.t == EXPR) a.sch = Model.toVal(a.sch, strval)
...
const sheet = {
  ...
  [TAG]: {
    nthChild: {
      0: { anyOf: [attrs({ key: "attr" })] },
    },
    children: {
      put: { pos: "append" },
      anyOf: [tag({ key: "span" }), ref(null, { to: [html()] }), text({ v: "" })],
      kDup: true
    }
  },
  [ATTR]: {
  ...
  [EXPR]: {
    children: { anyOf: [string, number, bool].map(a => a({ v: "" })) }
  }
}
