...
const sheet = {
  [DICT]: {
    ...
    nthChild: {
      0: { allowedSchs: [string()] },
      1: { allowedSchs: all.map(a => a()) }
    }
  },
  [E_RECORD]: {
    self: {
    ...
    nthChild: {
      0: { allowedSchs: [ref(null, { to: [record({ metadata: { strict: false } })] })] },
      1: { allowedSchs: [record()], exceptActions: [Actions.activateEditType, Actions.submitEdit] }
    }
  },
  [TAGGED_UNION]: {
    children: {
